...
<%@ page import="com.khushi.service.impl.*,com.khushi.service.*"%>
...
<body style="background-color: #adbdcc;">
	<!--Company Header Starting  -->
	<div class="container-fluid text-center"
		style="margin-top: 45px; background-color: #3d65a6; color: white; padding: 5px;">
		<h2>Khushi's Electronics</h2>
		...
		<p align="center"
			style="color: #E6F9E6; font-weight: bold; margin-top: 5px; margin-bottom: 5px;"
			id="message"></p>
	</div>
